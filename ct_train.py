...
@click.option('--arch',          help='Network architecture', metavar='ddpmpp|ncsnpp|adm',          type=click.Choice(['ddpmpp', 'ncsnpp', 'adm', "ncsnpp_celebahq"]), default='ddpmpp', show_default=True)
